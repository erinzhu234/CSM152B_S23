...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../project_3a.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"$ref_dir/../../../../project_3a.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../project_3a.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"../../../../project_3a.srcs/sources_1/bd/design_1/ipshared/ec67/hdl"
}
